...
extern int print_wheel_speed_camry(camry_wheel_speed_t *camry_wheel_speed);
//extern int print_vehicle_speed(camry_vehicle_speed_t *camry_vehicle_speed);
extern int print_long_lat_accel_camry(camry_long_lat_accel_t *camry_long_lat_accel);
extern int print_accel_cmd_status_camry(camry_accel_cmd_status_t *camry_accel_cmd_status);
extern int print_cruise_control_state_camry(camry_cruise_control_state_t *camry_cruise_control_state);
