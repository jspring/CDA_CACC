...
sleep 1
./veh_rcv -A 172.16.0.120 -a 172.16.1.120 -u 15000 -v -o 3 >veh_rcv_out_$DATETIME.txt 2>&1 &
sleep 1
./veh_snd -A 172.16.0.120 -a 172.16.1.120 -u 1516 -v >veh_snd_out_$DATETIME.txt 2>&1 &
sleep 1
./accord_can  >accord_can_out_$DATETIME.txt 2>&1 &
sleep 1
./argonne_cacc -v >/home/qnxuser/data/argonne_cacc_$DATETIME.txt 2>&1 &
