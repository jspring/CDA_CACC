...
sleep 1
./veh_snd -A 172.16.0.128 -a 172.16.1.128 -u 1516 -i 20 -t taur >veh_snd_$DATETIME$DESC.txt 2>&1 & 
sleep 1
./veh_rcv -A 172.16.0.128 -a 172.16.1.128 -u 15000 -o 3 >veh_rcv_out_$DATETIME.txt 2>&1 & 
sleep 1
echo "Starting taurus_can"
sleep 1
./taurus_can  >taurus_can_out_$DATETIME$DESC.txt 2>/dev/null  &
sleep 1
echo "Starting argonne_cacc"
./argonne_cacc -e 2 -i 1 -c 0 -m -f cacc_setup_taurus.cfg >argonne_cacc_$DATETIME$DESC.txt 2>/dev/null  &
