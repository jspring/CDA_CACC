...
sleep 1
./can_tx -i 0x99 -s 2 -p 1 -t 0.02 -v -n 4000 >can_tx_out_brake_$DATETIME.txt &
sleep 1
./prius_can -v >prius_can_out_$DATETIME.txt &
sleep 1
./argonne_cacc -h >/home/qnxuser/data/argonne_cacc_$DATETIME.txt &
