...
sleep 1	
./can_rx -p 2 >/mnt0/big/data/prius/obd2_rx_out_$DATETIME.txt 2>&1 &
sleep 1
./can_tx -i 0x99 -s 2 -p 1 -t 0.02 -n 4000 >/mnt0/big/data/prius/can_tx_out_brake_$DATETIME.txt 2>&1 &
sleep 1	
./can_tx -i 0x7fd -s 8 -p 2 -t 0.02 -n 5000 >/mnt0/big/data/prius/can_tx_obd2_$DATETIME.txt 2>&1 &
sleep 1
...
#./prius_can -v 
sleep 1
#./argonne_cacc -e 1 -i 2 -c 2 -x -h -f cacc_setup_prius.cfg
./argonne_cacc -e 1 -i 2 -c 2 -x -h -f cacc_setup_prius.cfg >/mnt0/big/data/prius/argonne_cacc_$DATETIME.txt &
